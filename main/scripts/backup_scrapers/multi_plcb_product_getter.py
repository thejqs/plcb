...
def write_unicorn_json_to_file(data):
    ...
    with open('/sites/projects/plcb/main/data/unicorns_json/unicorns-{}.json'.format(datetime.date.today()), 'a+') as f:
        print >> f, j
...
def hunt_unicorns(url=None):
    ...
    if url:
        ...
        with open('/sites/projects/plcb/main/data/product_codes/product_codes-{}.txt'.format(datetime.date.today()), 'r') as f:
